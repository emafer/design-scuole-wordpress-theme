        ...
        <div class="row variable-gutters">
            <div class="col">
                <div class="responsive-tabs-wrapper padding-top-200">
                    ...
                    <div class="tabs-img">
                        <img class="img-fluid" src="<?php echo  get_get_template_directory_uri(); ?>/assets/img/didattica-mockup.png" title="<?php _e("Gli indirizzi", "design_scuole_italia"); ?>" alt="<?php _e("La didattica", "design_scuole_italia"); ?>">
                    </div>

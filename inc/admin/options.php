...
function dsi_options_assets() {
    ...
    if(strpos($current_screen->id, 'configurazione_page_') !== false || $current_screen->id === 'toplevel_page_dsi_options') {
        wp_enqueue_style( 'dsi_options_dialog', get_get_template_directory_uri() . '/inc/admin-css/jquery-ui.css' );
        wp_enqueue_script( 'dsi_options_dialog', get_get_template_directory_uri() . '/inc/admin-js/options.js', array('jquery', 'jquery-ui-core', 'jquery-ui-dialog'), '1.0', true );
    }
}
